...
set COMMON_LINK_LIBRARIES=user32.lib ole32.lib shell32.lib gdi32.lib version.lib winmm.lib advapi32.lib imm32.lib oleAut32.lib setupapi.lib opengl32.lib OpenAL32.lib E:/Engine/vcpkg/installed/x64-windows/debug/lib/assimp-vc143-mtd.lib
...
cl /D TEARA_DEBUG /Wall /Zi /Fm /GR- /I %TEARA_HOME% /I %VCPKG_INCLUDE% /I "E:/Engine/vcpkg/installed/x64-windows/include/" %FILES_TO_COMPILE% /link /LIBPATH:%VCPKG_DEBUG_LIB% /LIBPATH:%VCPKG_DEBUG_BINARY% %COMMON_LINK_LIBRARIES% >> %BUILD_LOG_FILE%
